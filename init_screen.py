...
def init_screen(window, relogio):
    ...
    while init_sc:
        ...
        texto(window, f' F - para adicionar mais comidas', white, 15, 30 , altura - 120)
        texto(window, f' P - para adicionar mais venenos', white, 15, 30 , altura - 110)
        texto(window, f' V - para adicionar mais veículos', white, 15, 30 , altura - 100)
        texto(window, f' D - para visualizar ou deixar de ver o DNA dos veículos', white, 15, 30 , altura - 90)
        texto(window, f' R - para passar para a proxima geração de veículos', white, 15, 30 , altura - 80)
        texto(window, f' L - para diminuir o FPS', white, 15, 30 , altura - 70)
